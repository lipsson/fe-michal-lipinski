...
export const MessageList = ({ messages, currentUser, isLoading, isError }: MessageListProps) => {
  ...
  return (
    ...
    >
      ...
      {messages.map((msg) => (
        <MessageBubble key={msg._id} message={msg} isOwnMessage={msg.author === currentUser} />
      ))}
      <div ref={bottomRef} />
    </Box>
  );
